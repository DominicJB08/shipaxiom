...
await page.locator(".stack-card").getByText("Tool-loop specialist").click();
await primaryNav.getByRole("link", { name: "Model Stack" }).click();
await page.waitForTimeout(500);
await page.locator(".stack-table .stack-row", { hasText: "GLM-4.5-Air MLX" }).click();
...
await page.waitForTimeout(500);
await page.getByRole("button", { name: /Private AI Ops Audit/ }).click();
await page.waitForTimeout(350);
await page.getByRole("button", { name: /7-Day Pilot/ }).click();
